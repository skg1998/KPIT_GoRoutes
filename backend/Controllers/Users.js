...
const register = (req,res)=>{
    ...
    var {username,email,phone_number,car_number,password} = req.body;
    ...
    //check require feild
    if(!username || !email || !password ||!phone_number ||!car_number ){
    ...
    if(errors.length >0){
        ...
        console.log(username,email,phone_number,car_number,password);
        User.findOne({
            email:req.body.email
        })
        .then(user =>{
